...
| elementZIndex | number | Sets the z-index of the element. | 1000 |
| backdropZIndex | number | Sets the z-index of the backdrop. | 999 |
| backdropOnClick | () => void | Function to be called when the backdrop is clicked. | undefined |
